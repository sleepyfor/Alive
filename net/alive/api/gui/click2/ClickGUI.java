package net.alive.api.gui.click2;

import lombok.var;
import net.alive.Client;
import net.alive.api.gui.click2.component.Component;
import net.alive.api.gui.click2.component.button.CategoryButton;
import net.alive.api.gui.click2.component.button.ModuleButton;
import net.alive.api.gui.click2.component.value.BooleanComponent;
import net.alive.api.gui.click2.component.value.DoubleComponent;
import net.alive.api.gui.click2.component.value.IntegerComponent;
import net.alive.api.gui.click2.component.value.StringComponent;
