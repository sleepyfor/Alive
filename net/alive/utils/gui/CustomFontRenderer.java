...
public class CustomFontRenderer {
    ...
    private final char COLOR_INVOKER = '\u00A7';
    ...
    public CustomFontRenderer(final Font font, final int characterCount, final boolean fractionalMetrics) {
    ...
    private CharacterData[] setup(final CharacterData[] characterData, final int type) {
        ...
        for (int index = 0; index < characterData.length; ++index) {
            ...
            final Rectangle2D characterBounds = fontMetrics.getStringBounds(new StringBuilder(String.valueOf(character)).toString(), utilityGraphics);
    ...
    public String drawStringWithShadow(final String text, final float x, final float y, final int color) {
    ...
    public void drawCenteredString(String text, float x, float y, int color) {
        drawString(text, x - getWidth(text) / 2.001f, y, color);
    }

    public void drawCenteredStringWithShadow(String text, float x, float y, int color) {
        drawStringWithShadow(text, x - getWidth(text) / 2.001f, y, color);
    }
                    ...
                    if (index < 16) {
                        ...
                        switch (index) {
                            ...
                            case 21:
                                ...
                                underlined = false;
                                characterData = regularData;
                                GL11.glColor4d(1.0 * (shadow ? 0.25 : 1.0), 1.0 * (shadow ? 0.25 : 1.0), 1.0 * (shadow ? 0.25 : 1.0), a);
                                break;
                        }
                    }
                } else if (character <= '\u00ff') {
