package net.alive.utils.shader;
        ...
        try {
            ...
            switch (fragmentShaderLoc) {
                ...
                case "roundedRectGradient":
                    ...
                    break;
                default:
                    fragmentShaderID = createShader(mc.getResourceManager().getResource(new ResourceLocation("shaders/" + fragmentShaderLoc)).getInputStream(), GL_FRAGMENT_SHADER);
                    break;
            }
            glAttachShader(program, fragmentShaderID);

            int vertexShaderID = createShader(mc.getResourceManager().getResource(new ResourceLocation("shaders/" + vertexShaderLoc)).getInputStream(), GL_VERTEX_SHADER);
