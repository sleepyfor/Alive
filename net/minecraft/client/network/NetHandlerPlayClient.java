...
import net.alive.implement.events.packet.PacketType;
...
public class NetHandlerPlayClient implements INetHandlerPlayClient {
    ...
    public void addToSendQueueEvent(Packet p_147297_1_) {
        this.netManager.sendPacket(p_147297_1_);
    }

    public void addToSendQueue(Packet packet) {
        PacketEvent packetEvent = new PacketEvent(PacketType.OUTBOUND, packet);
        Client.INSTANCE.getEventBus().call(packetEvent);
